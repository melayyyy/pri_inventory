<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid mt-5">
      <div class="row">
        <div class="col-md-6">
          <h1 class="m-0 text-dark">Supply Issuance Report</h1>
        </div>
        <div class="col-md-6 mt-3">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="index.php?page=dashboard">Home</a></li>
            <li class="breadcrumb-item active">Issuance Report</li>
          </ol>
        </div>
      </div>
    </div>
              ...
              <div class="row">
                <div class="col-md-5 issueDateMethod" id="issueDateMethod">
                  <div class="form-group">
                    <label for="">Select Date Period</label>
                ...
                <div class="col-md-2" id="form-submit-btn" style="margin-top: 30px;">
                  <div class="form-group">
                    <input type="submit" id="search_sales_report" class="btn btn-primary btn-block" value="Generate Report">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="card-body">
          <table class="table table-striped table-bordered">
            <thead class="bg-light">
              <tr>
                <th>#</th>
                <th>RIS / Reference No.</th> <th>Date Issued</th>         <th>Division ID</th>         <th>Requested By / Division</th> <th>Total Value</th>         <th>Liquidated Amount</th>   <th>Pending Balance</th>     </tr>
            </thead>
